...
#define 	CW_MSG_ELEMENT_WTP_VENDORPAYLOD_CW_TYPE		50
...
//short because manage many WTPs
//#define 		CW_WAIT_JOIN_DEFAULT				60
#define 		CW_WAIT_JOIN_DEFAULT				10
...
#else
	#define		CW_JOIN_INTERVAL_DEFAULT 	10
#endif
...
#else
	//#define		CW_CHANGE_STATE_INTERVAL_DEFAULT 45
	#define		CW_CHANGE_STATE_INTERVAL_DEFAULT 10
#endif
...
#else
	#define		CW_NEIGHBORDEAD_INTERVAL_DEFAULT	120
	#define		CW_NEIGHBORDEAD_RESTART_DISCOVERY_DELTA_DEFAULT	((CW_NEIGHBORDEAD_INTERVAL_DEFAULT) + 40)
#endif
...
#else
	#define		CW_ECHO_INTERVAL_DEFAULT		60
#endif
